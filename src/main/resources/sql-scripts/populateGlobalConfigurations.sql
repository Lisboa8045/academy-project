...
INSERT IGNORE INTO global_configuration (id, config_name, config_key, config_value, config_type, created_at, updated_at, created_by, updated_by) VALUES
    ...
    (6,'Minimum days before cancellation in order to not pay', 'minimum_days_before_cancellation_to_not_pay', 3, 'INT', NOW(), NOW(), 'system', 'system'),
    (7, 'Account Deletion Expiry (days)', 'account_deletion_expiry_days', 30, 'INT', NOW(), NOW(), 'system', 'system');